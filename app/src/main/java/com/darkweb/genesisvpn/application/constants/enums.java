...
public class enums {
    ...
    public enum HOME_COMMANDS {
        ON_CONNECTED, ON_CONNECTING, ON_IDLE, ON_DISCONNECTING, INITIALIZE, AUTO_CONNECT, UPDATE_DOWNLOAD_SPEED, UPDATE_UPLOAD_SPEED, ON_ALERT_DISMISS, ON_CLEAR_FLAG, ON_CLEAR_FLAG_INSTANT, ON_MOVE_TASK_BACK, ON_FINISH_TASK, ON_SET_FLAG, ON_SET_FLAG_FORCED, ON_SHOW_ALERT
    }
